...
namespace Team_One
{
    public partial class Admin_Listed_Advisors_Table : System.Web.UI.Page
    {
        ...
        private void BindGridView()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                using (SqlCommand Listing = new SqlCommand("[Procedures_AdminListAdvisors]", conn))
                {
                    ...
                    using (SqlDataAdapter adapter = new SqlDataAdapter(Listing))
                    {
                        ...
                        if (dt.Rows.Count == 0)
                        {
                            Response.Write("There are no advisors");
                        }
                    }
                }
            }
